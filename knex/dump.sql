...
COMMENT ON TABLE "awards" IS 'awards table';
...
ALTER TABLE "awards" ADD FOREIGN KEY ("user_location_id") REFERENCES "user_locations" ("id");

ALTER TABLE "awards" ADD FOREIGN KEY ("product_id") REFERENCES "products" ("id");

ALTER TABLE "awards" ADD FOREIGN KEY ("assignee_id") REFERENCES "users" ("id");
